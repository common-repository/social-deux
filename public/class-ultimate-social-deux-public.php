...
class UltimateSocialDeux {
	...
	public function custom_css() {
		if ( intval( get_query_var( 'us_ccss' ) ) == 1 ) {
			...
			$floating_width = ( self::opt('us_floating_width', 'us_placement') ) ? intval(self::opt('us_floating_width', 'us_placement')): 45;
			
			$floating_height = ( self::opt('us_floating_height', 'us_placement') ) ? intval(self::opt('us_floating_height', 'us_placement')): 30;
			$floating_font_size = ( self::opt('us_floating_font_size', 'us_placement') ) ? intval(self::opt('us_floating_font_size', 'us_placement')): 16;
			...
			ob_start();
				...
				printf(".us_floating .us_wrapper .us_button { -webkit-transition: width %dms ease-in-out, background-color 400ms ease-out; -moz-transition: width %dms ease-in-out, background-color 400ms ease-out; -o-transition: width %dms ease-in-out, background-color 400ms ease-out; transition: width %dms ease-in-out, background-color 400ms ease-out; width: %spx; line-height: %spx;}", $floating_speed, $floating_speed, $floating_speed, $floating_speed, $floating_width, $floating_height );
				...
				printf(".us_floating .us_wrapper .us_button .us_box { font-size:%spx}", $floating_font_size);
				...
				/***** Pages top style. *****/
				$pages_top_width = ( self::opt('us_pages_top_width', 'us_placement') ) ? intval(self::opt('us_pages_top_width', 'us_placement')): 95;
				$pages_top_height = ( self::opt('us_pages_top_height', 'us_placement') ) ? intval(self::opt('us_pages_top_height', 'us_placement')): 30;
				$pages_top_font_size = ( self::opt('us_pages_top_font_size', 'us_placement') ) ? intval(self::opt('us_pages_top_font_size', 'us_placement')): 16;

				printf(".us_pages_top .us_wrapper .us_button { width: %spx; line-height: %spx;}", $pages_top_width, $pages_top_height);
				printf(".us_pages_top .us_wrapper .us_button .us_box { font-size: %spx}", $pages_top_font_size);
				
				/***** Pages bottom style. *****/
				$pages_bottom_width = ( self::opt('us_pages_bottom_width', 'us_placement') ) ? intval(self::opt('us_pages_bottom_width', 'us_placement')): 95;
				$pages_bottom_height = ( self::opt('us_pages_bottom_height', 'us_placement') ) ? intval(self::opt('us_pages_bottom_height', 'us_placement')): 30;
				$pages_bottom_font_size = ( self::opt('us_pages_bottom_font_size', 'us_placement') ) ? intval(self::opt('us_pages_bottom_font_size', 'us_placement')): 16;
				printf(".us_pages_bottom .us_wrapper .us_button { width: %spx; line-height: %spx;}", $pages_bottom_width, $pages_bottom_height);
				printf(".us_pages_bottom .us_wrapper .us_button .us_box { font-size: %spx}", $pages_bottom_font_size);
				
				
				
				/***** Posts excerpt top style. *****/
				$excerpts_top_width = ( self::opt('us_excerpts_top_width', 'us_placement') ) ? intval(self::opt('us_excerpts_top_width', 'us_placement')): 95;
				$excerpts_top_height = ( self::opt('us_excerpts_top_height', 'us_placement') ) ? intval(self::opt('us_excerpts_top_height', 'us_placement')): 30;
				$excerpts_top_font_size = ( self::opt('us_excerpts_top_font_size', 'us_placement') ) ? intval(self::opt('us_excerpts_top_font_size', 'us_placement')): 16;
				printf(".us_excerpts_top .us_wrapper .us_button { width: %spx; line-height: %spx;}", $excerpts_top_width, $excerpts_top_height);
				printf(".us_excerpts_top .us_wrapper .us_button .us_box { font-size: %spx}", $excerpts_top_font_size);
				
				
				/***** Posts excerpt bottom style. *****/
				$excerpts_bottom_width = ( self::opt('us_excerpts_bottom_width', 'us_placement') ) ? intval(self::opt('us_excerpts_bottom_width', 'us_placement')): 95;
				$excerpts_bottom_height = ( self::opt('us_excerpts_bottom_height', 'us_placement') ) ? intval(self::opt('us_excerpts_bottom_height', 'us_placement')): 30;
				$excerpts_bottom_font_size = ( self::opt('us_excerpts_bottom_font_size', 'us_placement') ) ? intval(self::opt('us_excerpts_bottom_font_size', 'us_placement')): 16;
				printf(".us_excerpts_bottom .us_wrapper .us_button { width: %spx; line-height: %spx;}", $excerpts_bottom_width, $excerpts_bottom_height);
				printf(".us_excerpts_bottom .us_wrapper .us_button .us_box { font-size: %spx}", $excerpts_bottom_font_size);
				
				
				/***** Posts top style. *****/
				$posts_top_width = ( self::opt('us_posts_top_width', 'us_placement') ) ? intval(self::opt('us_posts_top_width', 'us_placement')): 95;
				$posts_top_height = ( self::opt('us_posts_top_height', 'us_placement') ) ? intval(self::opt('us_posts_top_height', 'us_placement')): 30;
				$posts_top_font_size = ( self::opt('us_posts_top_font_size', 'us_placement') ) ? intval(self::opt('us_posts_top_font_size', 'us_placement')): 16;
				
				printf(".us_posts_top .us_wrapper .us_button { width: %spx; line-height:%spx; }", $posts_top_width, $posts_top_height);
				printf(".us_posts_top .us_wrapper .us_button .us_box { font-size: %spx}", $posts_top_font_size);
				
				/***** Posts bottom style. *****/
				$posts_bottom_width = ( self::opt('us_posts_bottom_width', 'us_placement') ) ? intval(self::opt('us_posts_bottom_width', 'us_placement')): 95;
				$posts_bottom_height = ( self::opt('us_posts_bottom_height', 'us_placement') ) ? intval(self::opt('us_posts_bottom_height', 'us_placement')): 30;
				$posts_bottom_font_size = ( self::opt('us_posts_bottom_font_size', 'us_placement') ) ? intval(self::opt('us_posts_bottom_font_size', 'us_placement')): 16;
				
				printf(".us_posts_bottom .us_wrapper .us_button { width: %spx; line-height:%spx; }", $posts_bottom_width, $posts_bottom_height);
				printf(".us_posts_bottom .us_wrapper .us_button .us_box { font-size: %spx}", $posts_bottom_font_size);
				
				
				
				/***** WooCommerce top style. *****/
				$woocommerce_top_width = ( self::opt('us_woocommerce_top_width', 'us_placement') ) ? intval(self::opt('us_woocommerce_top_width', 'us_placement')): 95;
				$woocommerce_top_height = ( self::opt('us_woocommerce_top_height', 'us_placement') ) ? intval(self::opt('us_woocommerce_top_height', 'us_placement')): 30;
				$woocommerce_top_font_size = ( self::opt('us_woocommerce_top_font_size', 'us_placement') ) ? intval(self::opt('us_woocommerce_top_font_size', 'us_placement')): 16;
				printf(".us_woocommerce_top .us_wrapper .us_button { width: %spx; line-height:%spx;}", $woocommerce_top_width, $woocommerce_top_height);
				printf(".us_woocommerce_top .us_wrapper .us_button .us_box { font-size: %spx}", $woocommerce_top_font_size);
				
				
				
				
				/***** WooCommerce bottom style. *****/
				$woocommerce_bottom_width = ( self::opt('us_woocommerce_bottom_width', 'us_placement') ) ? intval(self::opt('us_woocommerce_bottom_width', 'us_placement')): 95;
				$woocommerce_bottom_height = ( self::opt('us_woocommerce_bottom_height', 'us_placement') ) ? intval(self::opt('us_woocommerce_bottom_height', 'us_placement')): 30;
				$woocommerce_bottom_font_size = ( self::opt('us_woocommerce_bottom_font_size', 'us_placement') ) ? intval(self::opt('us_woocommerce_bottom_font_size', 'us_placement')): 16;
				printf(".us_woocommerce_bottom .us_wrapper .us_button { width: %spx; line-height:%spx; }", $woocommerce_bottom_width, $woocommerce_bottom_height);
				printf(".us_woocommerce_bottom .us_wrapper .us_button .us_box { font-size: %spx}", $woocommerce_bottom_font_size);
				
				
				
				/***** Jigoshop top style. *****/
				$jigoshop_top_width = ( self::opt('us_jigoshop_top_width', 'us_placement') ) ? intval(self::opt('us_jigoshop_top_width', 'us_placement')): 95;
				$jigoshop_top_height = ( self::opt('us_jigoshop_top_height', 'us_placement') ) ? intval(self::opt('us_jigoshop_top_height', 'us_placement')): 30;
				$jigoshop_top_font_size = ( self::opt('us_jigoshop_top_font_size', 'us_placement') ) ? intval(self::opt('us_jigoshop_top_font_size', 'us_placement')): 16;
				printf(".us_jigoshop_top .us_wrapper .us_button { width: %spx; line-height:%spx;}", $jigoshop_top_width, $jigoshop_top_height);
				printf(".us_jigoshop_top .us_wrapper .us_button .us_box { font-size: %spx}", $jigoshop_top_font_size);
				
				
				/***** Jigoshop bottom style. *****/
				$jigoshop_bottom_width = ( self::opt('us_jigoshop_bottom_width', 'us_placement') ) ? intval(self::opt('us_jigoshop_bottom_width', 'us_placement')): 95;
				$jigoshop_bottom_height = ( self::opt('us_jigoshop_bottom_height', 'us_placement') ) ? intval(self::opt('us_jigoshop_bottom_height', 'us_placement')): 30;
				$jigoshop_bottom_font_size = ( self::opt('us_jigoshop_bottom_font_size', 'us_placement') ) ? intval(self::opt('us_jigoshop_bottom_font_size', 'us_placement')): 16;
				printf(".us_jigoshop_bottom .us_wrapper .us_button {  width: %spx; line-height:%spx;}", $jigoshop_bottom_width, $jigoshop_bottom_height);
				printf(".us_jigoshop_bottom .us_wrapper .us_button .us_box { font-size: %spx}", $jigoshop_bottom_font_size);
				
				
				/***** Easy Digital Downloads top style. *****/
				$edd_top_width = ( self::opt('us_edd_top_width', 'us_placement') ) ? intval(self::opt('us_edd_top_width', 'us_placement')): 95;
				$edd_top_height = ( self::opt('us_edd_top_height', 'us_placement') ) ? intval(self::opt('us_edd_top_height', 'us_placement')): 30;
				$edd_top_font_size = ( self::opt('us_edd_top_font_size', 'us_placement') ) ? intval(self::opt('us_edd_top_font_size', 'us_placement')): 16;
				printf(".us_edd_top .us_wrapper .us_button { width: %spx; height:%spx;}", $edd_top_width, $edd_top_height);
				printf(".us_edd_top .us_wrapper .us_button .us_box { font-size: %spx}", $edd_top_font_size);
				
				
				/***** Easy Digital Downloads bottom style. *****/
				$edd_bottom_width = ( self::opt('us_edd_bottom_width', 'us_placement') ) ? intval(self::opt('us_edd_bottom_width', 'us_placement')): 95;
				$edd_bottom_height = ( self::opt('us_edd_bottom_height', 'us_placement') ) ? intval(self::opt('us_edd_bottom_height', 'us_placement')): 30;
				$edd_bottom_font_size = ( self::opt('us_edd_bottom_font_size', 'us_placement') ) ? intval(self::opt('us_edd_bottom_font_size', 'us_placement')): 16;
				printf(".us_edd_bottom .us_wrapper .us_button { width: %spx; line-height:%spx; }", $edd_bottom_width, $edd_bottom_height);
				printf(".us_edd_bottom .us_wrapper .us_button .us_box { font-size: %spx}", $edd_bottom_font_size);
				
				
				/***** Custom posts type top style. *****/
				$cpt_top_width = ( self::opt('us_cpt_top_width', 'us_placement') ) ? intval(self::opt('us_cpt_top_width', 'us_placement')): 95;
				$cpt_top_height = ( self::opt('us_cpt_top_height', 'us_placement') ) ? intval(self::opt('us_cpt_top_height', 'us_placement')): 30;
				$cpt_top_font_size = ( self::opt('us_cpt_top_font_size', 'us_placement') ) ? intval(self::opt('us_cpt_top_font_size', 'us_placement')): 16;
				printf(".us_cpt_top .us_wrapper .us_button { width: %spx; line-height:%spx;}", $cpt_top_width, $cpt_top_height);
				printf(".us_cpt_top .us_wrapper .us_button .us_box { font-size: %spx}", $cpt_top_font_size);	
				
				
				/***** Custom posts type bottom style. *****/
				$cpt_bottom_width = ( self::opt('us_cpt_bottom_width', 'us_placement') ) ? intval(self::opt('us_cpt_bottom_width', 'us_placement')): 95;
				$cpt_bottom_height = ( self::opt('us_cpt_bottom_height', 'us_placement') ) ? intval(self::opt('us_cpt_bottom_height', 'us_placement')): 30;
				$cpt_bottom_font_size = ( self::opt('us_cpt_bottom_font_size', 'us_placement') ) ? intval(self::opt('us_cpt_bottom_font_size', 'us_placement')): 16;
				printf(".us_cpt_bottom .us_wrapper .us_button {  width: %spx; line-height:%spx; }", $cpt_bottom_width, $cpt_bottom_height);
				printf(".us_cpt_bottom .us_wrapper .us_button .us_box { font-size: %spx}", $cpt_bottom_font_size);			
				...
				printf('@font-face { font-family: "ultimate-social";src:url("%s/ultimate-social.eot?63463400");src:	url("%s/ultimate-social.eot?63463400#iefix") format("embedded-opentype"),url("%s/ultimate-social.woff?63463400") format("woff"), url("%s/ultimate-social.ttf?63463400") format("truetype"), url("%s/ultimate-social.svg?63463400#ultimate-social") format("svg");font-weight: normal;font-style: normal;}', $plugin_font_dir, $plugin_font_dir, $plugin_font_dir, $plugin_font_dir, $plugin_font_dir);
				exit;
			ob_clean();
		}
	}
	...
	*/
	public function register_scripts() {
		...
		wp_register_script( 'us-script', plugins_url( 'assets/js/script.js',__FILE__ ), array('jquery', 'jquery-color'), self::VERSION );
