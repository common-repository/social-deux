...
if ( defined('WPB_VC_VERSION') ) {
	...
	vc_map(
		array(
			"name" => __("Ultimate Social - Total Count", 'ultimate-social-deux'),
			"base" => "ultimatesocial_total_false",
			"icon" => 'ultimate-social-deux',
			"category" => __('Social', 'ultimate-social-deux'),
			"params" => array(
				array(
	...
	vc_map(
		array(
			"name" => __("Ultimate Social - Total Count Only", 'ultimate-social-deux'),
			"base" => "ultimatesocial_total_only",
			"icon" => 'ultimate-social-deux',
			"category" => __('Social', 'ultimate-social-deux'),
			"params" => array(
				array(
